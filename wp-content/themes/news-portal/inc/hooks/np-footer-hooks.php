...
?>
		<div class="site-info">
			<span class="np-copyright-text">
				<?php 
					$news_portal_copyright_text = get_theme_mod( 'news_portal_copyright_text', __( 'ESTIEQUE', 'ESTIEQUE' ) );
					echo esc_html( $news_portal_copyright_text );
				?>
			</span>
			<span class="sep">  </span>
			<?php
				$news_portal_author_url = 'https:www.estiequealam.com';
				/* translators: 1: Theme name, 2: Theme author. */
				printf( esc_html__( 'Developed: %1$s by %2$s.', '' ), '', '<a href="'. esc_url( $news_portal_author_url ).'" rel="designer" target="_blank">ESTIEQUE</a>' );
			?>
		</div><!-- .site-info -->
<?php
	}
