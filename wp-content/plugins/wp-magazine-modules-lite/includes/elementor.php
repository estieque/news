...
if( !class_exists( 'Wpmagazine_Modules_Lite_Elements' ) ):
    class Wpmagazine_Modules_Lite_Elements {
        ...
        public function elementor_enqueue_scripts() {
            ...
            wp_enqueue_script( 'wpmagazine-modules-lite-elementor-public-script',
        ...
        public function elementor_editor_scripts() {
            ...
            wp_enqueue_style( 'wpmagazine-modules-lite-elementor-icon-style',
                plugins_url( 'assets/cvmm-icons/style.css', __FILE__ ),
                array(),
                WPMAGAZINE_MODULES_LITE_VERSION,
                'all'
            );

            wp_enqueue_style( 'wpmagazine-modules-lite-elementor-editor-style',
