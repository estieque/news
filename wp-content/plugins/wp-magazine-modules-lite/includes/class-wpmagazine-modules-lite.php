...
if( !class_exists( 'Wpmagazine_Modules_Lite' ) ):
    class Wpmagazine_Modules_Lite {
        ...
        public function enqueue_scripts() {
            ...
            wp_enqueue_script( 'wpmagazine-modules-lite-public-script',
            ...
            wp_enqueue_script( 'slick-slider',
                plugins_url( '/assets/library/slick-slider/js/slick.min.js', __FILE__ ),
                array( 'jquery' ),
                '1.8.0',
                true
            );
            ...
            wp_enqueue_script( 'jquery-marquee',
                plugins_url( '/assets/library/jQuery.Marquee/jquery.marquee.min.js', __FILE__ ),
                array( 'jquery' ),
                '1.0.0',
                true
            );
        ...
        function wpmagazine_modules_lite_layout_image_sizes() {
            // add_image_size( 'cvmm-large-medium', 720, 540, true );
            // add_image_size( 'cvmm-medium', 600, 450, true );
            // add_image_size( 'cvmm-small', 348, 261, true );
