...
export default class Edit extends Component {
    ...
    render() {
        ...
        if( !typographyOption ) {
            ...
            blockStyle +=' .block-' + blockID + ' .cvmm-banner-button-one{font-family: ' + button1FontFamily + ';font-weight: ' + button1FontWeight + ';font-size: ' + button1FontSize + 'px;text-transform: ' + button1TextTransform + ';color: ' + button1FontColor + '; text-align: ' + button1TextAlign + '; background-color: ' + button1BackgroundColor + ';padding-top: ' + button1PaddingTop + 'px;padding-right: ' + button1PaddingRight + 'px;padding-bottom: ' + button1PaddingBottom + 'px;padding-left: ' + button1PaddingLeft + 'px;border-style: ' + button1BorderType + ';border-width: ' + button1BorderWeight + 'px;border-color: ' + button1BorderColor + '}'

            blockStyle +=' .block-' + blockID + ' .cvmm-banner-button-two{font-family: ' + button2FontFamily + ';font-weight: ' + button2FontWeight + ';font-size: ' + button2FontSize + 'px;text-transform: ' + button2TextTransform + ';color: ' + button2FontColor + '; text-align: ' + button2TextAlign + '; background-color: ' + button2BackgroundColor + ';padding-top: ' + button2PaddingTop + 'px;padding-right: ' + button2PaddingRight + 'px;padding-bottom: ' + button2PaddingBottom + 'px;padding-left: ' + button2PaddingLeft + 'px;border-style: ' + button2BorderType + ';border-width: ' + button2BorderWeight + 'px;border-color: ' + button1BorderColor + '}'
        } else {
