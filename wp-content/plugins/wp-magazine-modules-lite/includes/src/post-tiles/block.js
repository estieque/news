...
registerBlockType( 'wpmagazine-modules/post-tiles', {
    title: escapeHTML( __( 'WP Magazine Post Tiles', 'wp-magazine-modules-lite' ) ),
    description: escapeHTML( __( 'Post collection with slider and featured section', 'wp-magazine-modules-lite' ) ),
    icon: {
        background: '#fff',
    ...
    keywords: [
        escapeHTML( __( 'tiles', 'wp-magazine-modules-lite' ) ),
        escapeHTML( __( 'featured', 'wp-magazine-modules-lite' ) )
    ],
    category: 'wpmagazine-modules-lite',
    attributes: posttilesAttributes,
