<?php
/**
 * Category Collection block layout default - php render.
 */
    if( $postMargin ) {
...
?>
    <div class="cvmm-cats-wrapper <?php echo esc_html( $postClass ); ?>">
        <?php
        $loop_count = 0;
                ...
                ?>
                        <div id="cat-<?php echo esc_attr( $catid ); ?>" class="cvmm-category">
                            ...
                            <div class="cvmm-cat-thumb">
                                <a href="<?php echo esc_url( $cat_link ); ?>" target="<?php echo esc_html( $permalinkTarget ); ?>"><img src="<?php echo esc_url( $image_url ); ?>" alt="<?php the_title(); ?>"/></a>
                            </div>
                            <?php
                                if( $titleOption === true ) {
                            ...
                            ?>
                                    <h2 class="cvmm-cat-title cvmm-cat-<?php echo absint( $cat_id ); ?>">
                                        <a href="<?php echo esc_url( $cat_link ); ?>" target="<?php echo esc_html( $permalinkTarget ); ?>">
