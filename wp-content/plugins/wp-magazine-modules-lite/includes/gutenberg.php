<?php
/**
 * Carry out the gutenberg actions regiater blocks, register scripts , styles , dependencies, and hooks.
 * 
...
if( !class_exists( 'Wpmagazine_Modules_Lite_Blocks' ) ) :
    class Wpmagazine_Modules_Lite_Blocks {
        ...
        /**
         * Load the dependencies, functions , register hoooks, scripts , styles on function call.
         */
        ...
        public function block_editor_enqueue_scripts() {
            ...
            wp_enqueue_style( 'wpmagazine-modules-lite-frontend',
            ...
            wp_enqueue_style( 'wpmagazine-modules-lite-block-editor',
                plugins_url( 'assets/css/build-editor.css', __FILE__ ),
                array(),
                WPMAGAZINE_MODULES_LITE_VERSION,
                'all'
            );
            ...
            wp_enqueue_style( 'fontawesome',
                plugins_url( 'assets/library/fontawesome/css/all.min.css', __FILE__ ),
                array(),
                '5.12.1',
                'all'
            );
            ...
            wp_enqueue_style( 'slick-slider',
                plugins_url( 'assets/library/slick-slider/css/slick.css', __FILE__ ),
                array(),
                '1.8.0',
                'all'
            );
            ...
            wp_enqueue_style( 'slick-slider-theme',
                plugins_url( 'assets/library/slick-slider/css/slick-theme.css', __FILE__ ),
                array(),
                '1.8.0',
                'all'
            );
            
            wp_enqueue_script( 'wpmagazine-modules-lite-block-build',
            ...
            wp_localize_script( 'wpmagazine-modules-lite-block-build', 'BlocksBuildObject', array(
